...
export const KNOWN_TEMPLATES = [
  ...
  },
  {
    ...
    sampleVars: {
      name: "Alex Doe",
      email: "alex@example.com",
      verifyUrl: "http://localhost:3000/verify-email/k4n3l2m9c8x7v6b5n4m3",
      appUrl: "http://localhost:3000",
      ttlMinutes: 1440,
    },
  },
  {
    ...
    sampleVars: {
      name: "Alex Doe",
      email: "alex@example.com",
      resetUrl: "http://localhost:3000/reset-password/k4n3l2m9c8x7v6b5n4m3",
      appUrl: "http://localhost:3000",
      ttlMinutes: 30,
    },
  },
  {
    ...
    sampleVars: {
      ...
      confirmUrl: "http://localhost:3000/verify-email/k4n3l2m9c8x7v6b5n4m3",
      appUrl: "http://localhost:3000",
      ttlMinutes: 1440,
    },
  },
